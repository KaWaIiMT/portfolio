...
export function NavBar() {
  ...
  return (
    ...
    >
      {/* Glass backdrop */}
      <div className="absolute inset-0 backdrop-blur-2xl bg-black/30 border-b border-white/[0.06]" />

      {/* Name / Logo */}
      <Link
        href="/"
        className="relative text-sm font-medium tracking-wide text-white/80 hover:text-white transition-colors"
      >
        池长俊
      </Link>
